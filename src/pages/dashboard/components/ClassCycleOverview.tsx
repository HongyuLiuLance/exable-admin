	...
	return(
		<>
			<div className={`ml-[24px] flex justify-between ${props.customStyle}`}>
				...
				<select className="dropdown mr-[47px] w-[280px] rounded-[17px] px-[16px] text-[14px] text-primary outline-none">
			...
			<div className="flex gap-[20px] ml-[24px] mr-[16px] text-primaryLight">
