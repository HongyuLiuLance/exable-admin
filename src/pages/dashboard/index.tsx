...
export const Dashboard: FunctionComponent<{}> = () => {
	...
	return(
		<div className="max-w-[1440px] mx-auto font-['Roboto'] font-normal">
			<div className="flex">
				{/* Left Section */}
				...
				<div className="w-full bg-primaryLight">
					...
					<div className="my-[64px] ml-[48px]">
						<h2 className="text-secondary text-[30px] font-bold">Overview</h2>
						<div className="mt-[30px] bg-primary max-w-[664px] pt-[24px] pb-[27px] rounded-[8px]">
